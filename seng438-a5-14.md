...
Reliability Growth Testing and Reliability Demonstration Testing should both be done on software in an ernviroment that is similar to the enviorment the software will be in when deployed. Both techniques evaluate the relioability of a piece of software, but each method serves a different purpose for evaluating reliability. Growth testing is used to assess the current reliability of the software, identify and eliminate faults in the software, and forecast future reliability. Reliability demonstration is used to verify if the software has reached a certain level of reliability such that it is deemed suitable for release. 
